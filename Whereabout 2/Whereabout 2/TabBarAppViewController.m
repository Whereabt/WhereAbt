...
- (void)viewDidLoad {
    ...
    UIImage *uploadSelectedImage = [UIImage imageNamed:@"icon-Upload 50x50.png"];
    ...
    UIImage *streamSelectedImage = [UIImage imageNamed:@"icon-Feed 50x50.png"];
    ...
    [self.viewControllers[2] setTabBarItem:streamTabBarItem];
    
    UIImage *profileNormalImage = [UIImage imageNamed:@"icon-Profile GRAY 50x50.png"];
    UIImage *profileSelectedImage = [UIImage imageNamed:@"icon-Profile 50x50.png"];
    ...
    [self.viewControllers[3] setTabBarItem:profileTabBarItem];
}
